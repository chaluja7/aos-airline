...
INSERT INTO flights(id, name, price, seats, distance, dateofdeparture, destination_from_id, destination_to_id) VALUES (3, 'Flight 3', 149.5, 70, 308.5, '2016-10-24 11:15:41', 1, 4);
INSERT INTO flights(id, name, price, seats, distance, dateofdeparture, destination_from_id, destination_to_id) VALUES (4, 'Flight 4', 149.5, 70, 308.5, '2016-10-24 11:15:41', 2, 4);
INSERT INTO flights(id, name, price, seats, distance, dateofdeparture, destination_from_id, destination_to_id) VALUES (5, 'Flight 5', 149.5, 70, 308.5, '2014-10-24 11:15:41', 4, 2);
